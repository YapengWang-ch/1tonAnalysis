...
# print(f"ch 10 in board {boardID[10]}")
# print(f"ch 16 in board {boardID[16]}")
# print(f"ch 24 in board {boardID[24]}")
# print(f"ch 32 in board {boardID[32]}")
# print(f"ch 48 in board {boardID[48]}")
# print(f"ch 53 in board {boardID[53]}")
# print(f"ch 56 in board {boardID[56]}")
# print(f"ch 45 in board {boardID[45]}")
