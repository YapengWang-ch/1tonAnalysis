...
void PreAnalyzer::WuYy_Calculate(iterator vbegin)
{
	...
	// auto peakList = _FindPeakAlgorithm_(vbegin,vbegin+WindowSize,chinfo.Pedestal,chinfo.FrontBslnStdDev*5); // 5 sigma for new electronics
	auto peakList = _FindPeakAlgorithm_(vbegin,vbegin+WindowSize,chinfo.Pedestal,100); // 30 bins for new electronics
